...
class CategoryTreeFrontPage extends CategoryTreeAbstract {
   ...
   public function getCategoryListAndParent(int $id)
   {
      ...
      $this->slugger = new AppExtension; //twig extension to sluggify urls for categories

      $parentData = $this->getMainParent($id); //main parent of subcategories
   ...
   {  
      ...
      $this->categorylist .=$this->html_1;
         foreach ($categories_array as $value)
         {
            ...
            $this->categorylist .=$this->html_2 . $this->html_3 . $url .
            $this->html_4 . $value['name'] .$this->html_5;
